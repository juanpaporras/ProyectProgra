...
<<<<<<< Updated upstream
	...
	// Recibe la columna donde quiere hacer la jugada, el tipo de jugada y la ficha
	// cae donde hay una fila
	// ocupada(ejem. fila 6 jugada X) y lo guarda fila anterior(fila 5= nueva jugada
	// O).
